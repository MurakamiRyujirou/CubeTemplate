...
namespace MurakamiRyujirou.Solver
{
    /// <summary>
    ///         ------
    ///        | 0 4 1|
    ...
    public static class CubeConverter
    {
        ...
        public static CubeModel Convert(MurakamiRyujirou.Cube.Cube cube)
        {
            int[] cp = new int[8];
            int[] co = new int[8];
            int[] ep = new int[12];
        ...
        private static byte GetCpByFace(Cubie cubie, Faces fx, Faces fy, Faces fz)
        {
            ...
            // Exception: Invalid argument error.Cubie=x=2,y=0,z=0,rx=90,ry=90,rz=270,color=R  Y G,(fx,fy,fz)=RIGHT,UP,FRONT,PanelColor=NONE,GREEN,NONE
        }
